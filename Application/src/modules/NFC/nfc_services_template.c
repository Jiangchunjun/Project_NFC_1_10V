...
// $Id: nfc_services_template.c 16930 2019-02-13 14:20:52Z g.salvador $
// $URL: https://app-ehnsvn02.int.osram-light.com/svn/EC/Toolbox1.0/Nfc/tags/v2.7/Src/nfc_services_template.c $
//
 ...
 * 	\retval	      NFC_STATUS_REGISTER_ECG_ON_VALUE
 * 	              NFC_STATUS_REGISTER_ECG_STDBY_VALUE
 * 	              NFC_STATUS_REGISTER_ECG_OFF_VALUE
 */
...
uint8_t NfcServices_GetEcgOnValue(nfc_mode_t ecg_state)
{
    switch (ecg_state)
    {
        ...
        case NFC_STANDBY:
            return NFC_STATUS_REGISTER_ECG_STDBY_VALUE;
            break;
