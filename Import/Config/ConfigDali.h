...
#define DALI_CONFIG_PHYSminLEVEL_log                                          85

///<-  Special definitions for the selected DaliDevice Type (s. DaliDeviceType_FEATURES.h for details)
#define DALI_CONFIG_TYPE6_GEAR_TYPE               (T6_GearType_LED_POWER_SUPPLY_INTEGRATED|T6_GearType_AC_SUPPLY_POSSIBLE|T6_GearType_DC_SUPPLY_POSSIBLE)
#define DALI_CONFIG_TYPE6_OPERATING_MODES         (T6_OperatingMode_PWM_POSSIBLE|T6_OperatingMode_AM_POSSIBLE|T6_OperatingMode_CONTROL_CURRENT_POSSIBLE)         // PWM & output current controlled                                                                            // .. and select the Features supported. Here: short circuit & thermal shut down (s. DaliDeviceType_FEATURES.h)
